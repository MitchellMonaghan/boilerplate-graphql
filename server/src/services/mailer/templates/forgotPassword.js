  ...
  const html = `
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <title>Password reset for ${config.productName}</title>
        <!-- 
      ...
      <body>
        <span class="preheader">A password reset has been requested for ${data.email}. Please click the link below to reset your password.</span>
                    ...
                    <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="content-cell">
                          ...
                          <p>A password reset has been requested for ${data.email}.</p>
                                  ...
                                  <tr>
                                    <td align="center">
                                      <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td>
                                            <a href="${forgotPasswordUrl}" class="button button--" target="_blank">
                                              Reset password.
                                            </a>
                                          </td>
                                        </tr>
                          ...
                          <table class="body-sub">
                            <tr>
                              <td>
                                ...
                                <p class="sub">${forgotPasswordUrl}</p>
                              </td>
                            </tr>
                          </table>
                        </td>
